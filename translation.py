class Translation(object):
    START_TEXT = """ <b> Hi <a href='tg://user?id={}'>{}</a> . I'm A Simple File Renamer + File To Video Converter Bot With Permanent Thumbnail support!💯</b> \n
...
"""
    ...
    BANNED_USER_TEXT = "Sorry!! Wolf Owner As Banned You From Using This Service. That Means You Can't Run Meh Now! \n \n Contact Support Group : @ML_SupportGroup For more Details.. " 
    ABS_TEXT = "What Are You Trying To Do,Mate?"
    UPGRADE_TEXT = "<b>😜 Hey <a href='tg://user?id={}'>{}</a> All Features are free now , in future there may be .😁 "
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "**Thank you for Using Me JOin. Join @ML_BotUpdates & Support us \n\n ® @ML_BotUpdates**"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds.\nUploaded in {} seconds"
    NOT_AUTH_USER_TEXT = "CONTACT @Itz_Me_Malayaali "
    NOT_AUTH_USER_TEXT_FILE_SIZE = "IF You Got This Message You Should Contact @tz_Me_Malayaali "
